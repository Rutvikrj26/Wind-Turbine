...
/* Torque Calculations */
#define lambda_del(torque, timestep) (radius*torque*timestep/(moi*vel_inf)) 
...
//        // printf("%g\n", source);    
    ...
    lambda = lambda + lambda_del((source*x[1]), timestep);
...
//        // printf("%g\n", source);    
    ...
    lambda = lambda + lambda_del(source*x[0], timestep);
    }
